apt install bleachbit mc default-jdk gparted curl ntfs-3g ufw freerdp3-x11 -y && ufw default deny incoming && ufw default allow outgoing && ufw allow 22 && ufw allow 22022 && ufw allow 11434 && ufw allow 8080 && ufw allow 8006 && ufw allow 5678 && ufw allow 9443 && ufw enable
...
apt install git linux-headers-$(uname -r) build-essential meson itstool libtool pkg-config intltool libicu-dev libpcre2-dev libglib2.0-dev libgtk-3-dev libxml2-utils -y
